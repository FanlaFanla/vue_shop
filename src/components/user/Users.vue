...
export default {
    data(){
        ...
        var checkMobile = (rule, value, callback) => {
            //验证手机号的正则表达式
            const regMobile = /^(0|86|178951)?(13[0-9]|15[012356789]|17[678]|18[0-9]{8}$)/
        ...
        return {
            ...
            addFormRules:{
                ...
                password:[
                    {required: true,message:'请输入密码',trigger: 'blur'},{min:6,max:16,message:'密码的长度在6~16个字符之间',trigger:'blur'}
                ],
                email: [
